...
print(f"Initial value of input_double_register_0: {setp.input_double_register_0}")

# Set a new value
setp.input_double_register_0 = 9999.207586086
...
setp = con.receive()
print(f"Current value of input_double_register_0: {setp.input_double_register_0}")
