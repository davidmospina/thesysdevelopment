...
targetMiddle = [0.28697383813837185, -0.14998050513491248, 0.5909854580323809, -0.16554934951083813, 1.567441645128796, -0.2602440801528517]
# targetA = [value / 1000 for value in targetA]        
targetA = targetMiddle.copy()
targetA[1] = -0.4499805051349124  # Modify the 4th element of targetB
targetB = targetMiddle.copy()
targetB[1] = 0.4499805051349124  # Modify the 4th element of targetB
rtde_c.moveJ_IK(targetMiddle, 0.25, 0.5, False)
